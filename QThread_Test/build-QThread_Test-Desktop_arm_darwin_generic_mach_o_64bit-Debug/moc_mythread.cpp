...
QT_MOC_LITERAL(1, 9, 9), // "passbynum"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 2) // "id"

    },
    "MyThread\0passbynum\0\0id"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->passbynum((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::passbynum)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::passbynum(int _t1)
{
